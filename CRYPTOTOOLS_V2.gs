 ...
 *
 * Available protocols can be found https://api.zapper.fi/api/static/index.html#/Protocol%20Balances/BalanceController_getSupportedV2Balances
 *
 * By default, data gets transformed into a list. 
 * For example:
 *
